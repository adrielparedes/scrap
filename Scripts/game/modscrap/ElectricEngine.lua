...
local obj_interactive_eletricenginepower = sm.uuid.new("5306ec74-cf53-44c0-ab28-f55624151041")
...
local EngineLevels = {
	...
	[tostring(obj_interactive_eletricenginepower)] = {
		gears = Gears,
		effect = "ElectricEngine - Level 3",
		title = "MAXPOWER",
		gearCount = #maxPowerGears,
		bearingCount = 14,
		pointsPerBattery = 30000
	}
}
